...
def clear_asset_group(USERNAME,PASSWORD,unique_id,file_id):
    dellog_path = os.path.join(os.path.dirname('QualysAPIFinal\Logs\ApiLogs\Asset_group_deletion_log.xml'),f'Asset_group_deletion_{file_id}_log.xml')
...
def update_Asset_group(USERNAME,PASSWORD,unique_id,ipdata,file_id):
    updatelog_path = os.path.join(os.path.dirname('QualysAPIFinal\Logs\ApiLogs\Asset_group_updation_log.xml'),f'Asset_group_updation{file_id}_log.xml')
